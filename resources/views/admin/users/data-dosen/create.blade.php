...
@section('content')
  ...
  <div class="form-card">
    <div class="form-card-header">
      <h5 class="mb-1 fw-semibold">Form Tambah Dosen</h5>
      <p class="text-muted mb-0" style="font-size: 0.875rem;">Lengkapi data dosen dengan benar</p>
    </div>
    
    <div class="form-card-body">
      <form id="formDosenCreate" action="{{ route('admin.dosen.store') }}" method="POST">
        @csrf
        ...
        <div class="alert alert-info">
          ...
          <strong>Informasi:</strong> Username dan password akan di-generate otomatis dan ditampilkan setelah data dosen berhasil disimpan.
        </div>
        
        
        <!-- Action Buttons -->
        <div class="d-flex gap-2 justify-content-end">
          <button type="submit" class="btn btn-success btn-action" style="background-color:#0e4a95;border-color:#0e4a95;">
...
@push('scripts')
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const form = document.getElementById('formDosenCreate');
      if (!form) return;
