...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="formRuanganEdit" action="{{ route('ruangan.update', $ruangan->id) }}" method="POST">
            @csrf
            @method('PUT')
            
            <!-- Hidden status field to maintain existing status -->
            <input type="hidden" name="status" value="{{ $ruangan->status }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="kode" id="kode" class="form-control @error('kode') is-invalid @enderror" 
                           value="{{ old('kode', $ruangan->kode) }}" placeholder="Contoh: R101, LAB-A" required autofocus>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" 
                           value="{{ old('nama', $ruangan->nama) }}" placeholder="Contoh: Ruang Kuliah 101" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="kapasitas" id="kapasitas" class="form-control @error('kapasitas') is-invalid @enderror" 
                           value="{{ old('kapasitas', $ruangan->kapasitas) }}" min="1" max="500" required>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" 
                              rows="3" placeholder="Catatan tambahan tentang ruangan (opsional)">{{ old('keterangan', $ruangan->keterangan) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
  const form = document.getElementById('formRuanganEdit');
  if (!form) return;
