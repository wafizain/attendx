-- DROP tabel lama dan buat ulang dari awal
...
-- 2. Buat tabel mahasiswa dari awal
...
-- 3. Buat tabel mahasiswa_biometrik
...
-- 5. Tandai migration sebagai sudah dijalankan
INSERT INTO `migrations` (`migration`, `batch`) 
VALUES 
('2025_11_09_000000_update_mahasiswa_system', (SELECT COALESCE(MAX(batch), 0) + 1 FROM (SELECT * FROM migrations) AS m)),
('2025_11_09_000001_fix_dosen_and_mahasiswa_tables', (SELECT COALESCE(MAX(batch), 0) + 1 FROM (SELECT * FROM migrations) AS m))
